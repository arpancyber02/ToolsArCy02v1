...
echo -e  "Tools    : Arpan Cyber 02 $white         " |lolcat
echo -e  "Creadby  : Bang Arab 02 $white   " |lolcat
echo -e  "Contact  : ilhamarpan21@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Bang Arab 02" | lolcat
exit
;;
